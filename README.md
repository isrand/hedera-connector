...
> **Warning**
> Either in 1. or 2., the key pairs that were not imported and had to be generated by the microservice **only** reside in the container's filesystem, under the `/opt/wallet` path. Make sure to keep a copy.
