...
if(!fs.existsSync('chart/artifacts')) {
  fs.mkdirSync('chart/artifacts');
}

if (!fs.existsSync('chart/artifacts/kyber_512.pub') && !fs.existsSync('chart/artifacts/kyber_512.priv')) {
...
if (!fs.existsSync('chart/artifacts/kyber_768.pub') && !fs.existsSync('chart/artifacts/kyber_768.priv')) {
...
if (!fs.existsSync('chart/artifacts/kyber_1024.pub') && !fs.existsSync('chart/artifacts/kyber_1024.priv')) {
